...
R package **piamutils**, version **0.0.5**
...
Benke F, Schötz C (2024). _piamutils: Utilities for the piam-verse_. R package version 0.0.5, <https://github.com/pik-piam/piamutils>.
